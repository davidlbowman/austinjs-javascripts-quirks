 ...
 * When comparing a BigInt with a number or a string using ==, JavaScript performs type coercion.
 ...
 * When comparing a BigInt with a number or a string using ===, no type coercion occurs.
 ...
 * BigInt values are created by appending 'n' to the end of an integer literal or by calling the BigInt() function.
 ...
 * When comparing BigInt values with other types using ===, no type coercion occurs, and the types must match for equality.
 */
